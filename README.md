...
7. Повторили пункты 4−7 много-много ра  
...
Сообщения важно оформлять правильно, чтобы было понятно конкретно о чем идет речь.  
**Пример информативного сообщения:**  
* Оптимизирована загрузка фотографий в галерее  

**Пример неинформативного сооьщения:**  
* быстрофикс  
